...
window.P$ = new p5(p5c => {
  ...
  class Helper {
    ...
    */
    addAuthor() {
      ...
      p5c.text(this.name, p5c.width / 4 + 10, 5 * p5c.height / 6 - p5c.height / 10 - p5c.height / 40 - 2)
      p5c.pop()
    }
    /*
  ...
  */
  ...
  drawTrainingButton = function () {
    ...
    p5c.strokeWeight(2)
    p5c.rectMode(p5c.CENTER)
    p5c.rect(p5c.width / 2, p5c.height / 2, p5c.width / 6, p5c.height / 8)
    p5c.textSize(30)
    p5c.textAlign(p5c.CENTER, p5c.CENTER)
    p5c.fill(255)
    p5c.text("Start training!", p5c.width / 2, p5c.height / 2)
    p5c.pop()
  }
  ...
  */
  drawMenu = function () {
    ...
    for (var i = 0; i < 100; i++) {
      ...
      p5c.fill(p5c.lerpColor(p5c.color(0, 0, 255), p5c.color(71, 175, 255), i / 95));
    ...
    //using lerpColor() by subdividing it into 50 parts
    for (var i = 0; i < 100; i++) {
      p5c.fill(p5c.lerpColor(p5c.color(250, 127, 250), p5c.color(120, 0, 255), i / 100));
    ...
    p5c.fill(255);
    p5c.textFont('Aldrich')
    p5c.text("Record some sounds", p5c.width / 4, p5c.height / 2.1);
    p5c.text("Upload a file", p5c.width * 3 / 4, p5c.height / 2.1);
    //write "(note - audio longer than "+maxDuration+" seconds will be cut to "+maxDuration+" seconds)" below Upload in a smaller font
    p5c.textSize(18);
    p5c.text("(audio longer than " + maxDuration + " seconds will be cut to " + maxDuration + " seconds)", p5c.width * 3 / 4, p5c.height / 2.2 + 50);
    p5c.textSize(30);
    ...
    let e = p5c.round(p5c.height / (5))
    let f = p5c.round(p5c.height / (4))
    let g = p5c.round(p5c.height / (3.7))
    let h = p5c.round(p5c.height / (8))
    p5c.textSize(17);
    p5c.textFont('Aldrich')
    p5c.text("Your helper", p5c.width - a, p5c.height - h);
    p5c.stroke(255)
    p5c.noFill()

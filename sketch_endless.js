...
p5_instance = function (p5c) {
  ...
  */
  ...
  var posRecord = 5;
  // FAKE RANKING
  namesRanking[0] = "Paolo"
  namesRanking[1] = "Elena"
  namesRanking[2] = "Riccardo"
  namesRanking[3] = "Bianca"
  namesRanking[4] = "Giovanni"
  pointsRanking[0] = 10742
  pointsRanking[1] = 8940
  pointsRanking[2] = 7856
  pointsRanking[3] = 5738
  pointsRanking[4] = 3106
  // TUTORIAL STUFF
  ...
  */
  p5c.draw = function () {
    ...
    if (started) {
      ...
      p5c.noStroke()
      p5c.textSize(25)
      p5c.text("Lifes : " + lifes, p5c.width/2, p5c.height/1.4)
    ...
    */
    ...
    tutorialBackground = function () {
        ...
        p5c.rect(p5c.width/2,p5c.height/2,1000,540)
        p5c.translate(480, 270);
